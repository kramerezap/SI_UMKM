			...
			<div class="sidebar-scroll">
				<nav>
                  ...
                  <li><a href="/cabang" class="">Cabang</a></li>
									<li><a href="/valpelanggan" class="active">Pelanggan</a></li>
								</ul>
							</div>
						</li>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/tambahpelanggan" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
      ...
      <div class="modal fade" id="modal-edit{{$data->ID_USER}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="/editpelanggan={{$data->ID_USER}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                      ...
                      @endphp
											...
											<tr>
												...
												<td><img src="Assets1/images/FOTO/{{$data->FOTO}}" width="60" height="60" alt="User"></td>
												 -->
                         @if($data->STATUS==1)
												<td><a href="/ubahstatuspel1={{$data->ID_USER}}" type="button" class="btn btn-success">Aktif</a></td>
												@elseif($data->STATUS==2)
                        <td><a href="/ubahstatuspel2={{$data->ID_USER}}" type="button" class="btn btn-danger">NonAktif</a></td>
                        @elseif($data->STATUS==0)
												<td><a href="/ubahstatuspel2={{$data->ID_USER}}" type="button" class="btn btn-warning">Belum Terdaftar</a></td>
												@endif
                          ...
                          <a href="/pemilik:hapuspelanggan={{$data->ID_USER}}"  class="btn btn-danger btn-xs"  onclick="return(confirm('Anda Yakin Menghapus?? '));"><span class="lnr lnr-trash"></span></a>
                        </td>
