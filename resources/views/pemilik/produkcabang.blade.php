...
@section('extrastyle')
<?php
$ambilpro = DB::SELECT("select * from stok_cabang a, cabang b, produk c where a.ID_CABANG= b.ID_CABANG and a.ID_PRODUK = c.ID_PRODUK");
?>
@endsection
@section('sidebar')
            ...
            <div class="col-md-12">
              ...
              <div class="panel" style="">
                <div class="panel-heading" >
                  <h3 class="panel-title">Data Produk per Cabang</h3>
                </div>
